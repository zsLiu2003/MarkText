...
class DipperParaphraser(object):
    def __init__(self, model="/data2/huggingface-mirror/dataroot/models/kalpeshk2011/dipper-paraphraser-xxl", verbose=True):
        time1 = time.time()
        self.tokenizer = T5Tokenizer.from_pretrained('/data2/huggingface-mirror/dataroot/models/google/t5-v1_1-xxl')
    ...
    def paraphrase(self, input_text, lex_diversity=40, order_diversity=60, prefix="", sent_interval=3, **kwargs):
