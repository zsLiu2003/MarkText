...
def train_full(model_name, dataset_name, sft_args):
    ...
    tokenizer.save_pretrained("/data1/lzs/MarkText/fine-tuning/WizardLM-full")
    fine_tuning_full.model.save_pretrained("/data1/lzs/MarkText/fine-tuning/WizardLM-full")

if __name__ == "__main__":
    model = "/data2/model/Quantize/WizardLM_normal"
    dataset_name = "mlabonne/guanaco-llama2-1k"
    sft_train_params = TrainingArguments(
        output_dir="/data1/lzs/MarkText/fine-tuning/checkpoints/WizardLM-full",
        num_train_epochs=1,
