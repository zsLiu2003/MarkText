...
class Extraction():
    ...
    def data_extraction(model_name: str,dataset_name: str):
        ...
        output_path = "/data1/lzs/MarkText/Attack/extraction_attack/WizardLM_dictdata.json"
    ...
    def train_new_model(
        ...
        trainer = SFTTrainer(
            ...
            args=transformers.TrainingArguments(
                output_dir="/data1/lzs/MarkText/Attack/extraction_attack/checkpoint/WizardLM",
                num_train_epochs=4,
        ...
        trainer.train()
        tokenizer.save_pretrained("/data1/lzs/MarkText/extraction/WizardLM")
        trainer.model.save_pretrained("/data1/lzs/MarkText/extraction/WizardLM")



if __name__ == "__main__":
    #output_path = Extraction.data_extraction(str("/data2/model/Quantize/WizardLM_normal"),str("togethercomputer/llama-instruct"))
    Extraction.train_new_model(str("/data2/huggingface-mirror/dataroot/models/meta-llama/Llama-2-7b-hf"), str("/data1/lzs/MarkText/Attack/extraction_attack/WizardLM_dictdata.jsonl"))
