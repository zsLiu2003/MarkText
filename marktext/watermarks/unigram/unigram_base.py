...
from transformers import LogitsWarper, PreTrainedTokenizerBase
import hashlib
...
# Watermark scheme from https://github.com/XuandongZhao/Unigram-Watermark
...
class UnigramWatermarkGenerator(GPTWatermarkBase,LogitsWarper):
    """
...
class UnigramWatermarkDetector(GPTWatermarkBase):
    ...
    def dynamic_threshold(self, sequence: List[int], alpha: float, vocab_size: int):
        ...
        return bool(z_score > tau), float(z_score)