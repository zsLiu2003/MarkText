...
def generate_watermarktext(config_file, watermarks=None, generate_text_path = str):
    ...
    id = 0
    watermark_path = ''
    watermark_name = config_class.watermark_name
    ...
    for generation in tqdm(generations,desc = f"Processing {watermark_name} watermarks:"):
        watermark_name = str(watermark_name)
